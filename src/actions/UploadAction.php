<?php
namespace nataxa\filekit\actions;

use League\Flysystem\FilesystemInterface;
use nataxa\filekit\events\UploadEvent;
...
*   return [
*           'upload'=>[
*               'class'=>'nataxa\filekit\actions\UploadAction',
*           ]
*       ];
*   }
*/
class UploadAction extends BaseAction
{
    ...
    public function init()
    {
        ...
        if (\Yii::$app->request->post('fileparam')) {
            $this->fileparam = \Yii::$app->request->post('fileparam');
        }

        if (\Yii::$app->request->post('upload-path')) {
            $this->uploadPath = \Yii::$app->request->post('upload-path');
        }
