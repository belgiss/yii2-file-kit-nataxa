<?php
namespace nataxa\filekit;

use Yii;
use League\Flysystem\FilesystemInterface;
use nataxa\filekit\events\StorageEvent;
use nataxa\filekit\filesystem\FilesystemBuilderInterface;
...
class Storage extends Component
{
    ...
    protected function getDirIndex($path = '')
    {
        ...
        if (!$this->getFilesystem()->has($normalizedPath)) {
            ...
            if ($this->maxDirFiles !== -1) {
                ...
                $filesCount = count($this->getFilesystem()->listContents($path . DIRECTORY_SEPARATOR . $this->dirindex));
    ...
    {
        /* @var \nataxa\filekit\events\StorageEvent $event */
